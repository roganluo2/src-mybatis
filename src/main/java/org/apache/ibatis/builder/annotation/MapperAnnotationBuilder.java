...
//          如果解析过程中出现IncompleteElementException异常，可能是引用了未解析的注解，
//          这里将出现异常的方法添加到Configuration.incompleteMethods集合中暂存
...
//    获取configuration.incompleteStatement集合
    Collection<MethodResolver> incompleteMethods = configuration.getIncompleteMethods();
    synchronized (incompleteMethods) {
//      遍历incompetenStatements集合
