...
//    负责创建cache 对象，并将其添加到configuration.caches集合中保存
  public Cache useNewCache(Class<? extends Cache> typeClass,
      ...
      boolean blocking,
      Properties props) {
//      创建cache 对象，这里使用了建造者模式，cachebuilder是建造者的角色，而cache是生成的产品
...
//        如果当前resultmap节点中定义了constructor节点，则不需要使用父resultMap中记录的相应constructor节点，则将其对应的resultMapping对象删除
...
//      创建resultMap对象，并添加configuration.resultMaps集合中保存
  ...
  public ResultMapping buildResultMapping(
      ...
      boolean lazy) {
//      解析resulttype节点指定的property属性的类型
    Class<?> javaTypeClass = resolveResultJavaType(resultType, property, javaType);
//      获取typeHandler指定的TypeHandler对象，底层依赖于typeHandlerRegistry
    TypeHandler<?> typeHandlerInstance = resolveTypeHandler(javaTypeClass, typeHandler);
//      解析column属性值，当column是{prop1=col1,prop2=col2}形式，会解析成resultMapping对象集合，
